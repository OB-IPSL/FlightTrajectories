...
#--path ERA5 - u and v wind data - hourly data
pathERA5='/projsu/cmip-work/oboucher/ERA5/'
...
def wind(lons,lats):
   ...
   windu=xr_u200_reduced.sel(latitude=lats_z,z=lons_z)['u'].values
   windv=xr_v200_reduced.sel(latitude=lats_z,z=lons_z)['v'].values
...
#file_u=pathERA5+'u.'+stryr+'01.ap1e5.GLOBAL_025.nc'
#file_v=pathERA5+'v.'+stryr+'01.ap1e5.GLOBAL_025.nc'
#file_t=pathERA5+'ta.'+stryr+'01.ap1e5.GLOBAL_025.nc'
#file_r=pathERA5+'r.'+stryr+'01.ap1e5.GLOBAL_025.nc'
print(file_u)
print(file_v)
print(file_t)
print(file_r)
...
for iagos_file in iagos_files:
  ...
  xr_u200_values_t=np.zeros((xr_u200_values.shape))
  xr_v200_values_t=np.zeros((xr_v200_values.shape))
  for t in range(nbts):
      xr_u200_values_t[t,:,:],xr_v200_values_t[t,:,:]=rotated.transform_vectors(plate,xx,yy,xr_u200_values[t,:,:],xr_v200_values[t,:,:])
  #
  #--rotate meshgrid
  ...
  for t in range(nbts):
     xr_u200_values[t,:,:]=interpolate.griddata(xx_t_yy_t,xr_u200_values_t[t,:,:].flatten(),(xx,yy),method='nearest')
     xr_v200_values[t,:,:]=interpolate.griddata(xx_t_yy_t,xr_v200_values_t[t,:,:].flatten(),(xx,yy),method='nearest')
  #
